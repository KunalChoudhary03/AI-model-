      ...
      <div className="chat-header-left">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="menu-icon">
            <path fillRule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 410 1.5H3.75A.75.75 0 713 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 410 1.5H3.75A.75.75 0 713 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 410 1.5H3.75a.75.75 0 01-.75-.75z" clipRule="evenodd" />
          </svg>
        </button>
            ...
            {user ? (
              ...
              >
                <div className="user-profile-content">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    ...
                    <text x="12" y="17" textAnchor="middle" fontSize="12" fill="#8B4513">í±¤</text>
                  </svg>
              ...
              <button className="profile-button" aria-label="Profile/Login/Register" onClick={handleProfileClick}>
                <svg width="20" height="20" viewBox="0 0 32 32" fill="none">
                  ...
                  <text x="16" y="21" textAnchor="middle" fontSize="16" fill="#8B4513">í±¤</text>
                </svg>
              </button>
            )}
          </div>
